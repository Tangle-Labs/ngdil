...
import { y as peterChosenStudent } from './flows.store-b2e554df.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"container svelte-4kg7bv"}"><div class="${"heading svelte-4kg7bv"}">${validate_component(Typography, "Typography").$$render($$result, { variant: "heading" }, {}, {
    default: () => {
      return `${`To evaluate ${escape($peterChosenStudent == null ? void 0 : $peterChosenStudent.split(" ")[0])}\u2019s eligibility ${validate_component(Highlight, "Highlight").$$render($$result, {}, {}, {
        default: () => {
    ...
    {},
    {
      default: () => {
        return `<div class="${"sidebar svelte-4kg7bv"}">${each(Array(5), (i) => {
          ...
          {
            default: () => {
              return `${escape($peterChosenStudent == null ? void 0 : $peterChosenStudent.toLocaleUpperCase())}`;
            }
          }
        )}</div>
...
//# sourceMappingURL=_page.svelte-03be609d.js.map
