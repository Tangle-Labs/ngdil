...
import { s as imaniChosenStaff } from './flows.store-Ch_DhNys.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Modal, "Modal").$$render(
      ...
      },
      {
        default: () => {
          return `<div class="modal-content svelte-1cr370x"><img src="/imgs/future-tech.png" alt="" class="logo svelte-1cr370x"> <div class="heading svelte-1cr370x">${validate_component(Typography, "Typography").$$render(
            ...
            {
              default: () => {
                return `${escape($_("journeys.imani.staff_attended_training_see_results"))}`;
              }
            }
          )} <div class="p svelte-1cr370x">${validate_component(Typography, "Typography").$$render($$result, { color: "--black-500" }, {}, {
            default: () => {
              return `${escape($_("journeys.imani.to_view_staff_result_click_continue_to_result"))}`;
            }
      ...
      default: () => {
        return `<!-- HTML_TAG_START -->${highlight($_("journeys.imani.4_staff_available_for_training_select_1"))}<!-- HTML_TAG_END -->`;
      }
    })}</div> <div class="sub-text svelte-1cr370x">${validate_component(Typography, "Typography").$$render($$result, {}, {}, {
      default: () => {
        return `${escape($_("journeys.imani.select_emp_to_train_and_click_train_staff"))}`;
      }
...
//# sourceMappingURL=_page.svelte-Cr3KVAYU.js.map
