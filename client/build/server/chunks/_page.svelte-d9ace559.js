  ...
  return `<div class="container svelte-wu4iii"><div class="heading svelte-wu4iii">${validate_component(Typography, "Typography").$$render($$result, { variant: "heading" }, {}, {
    default: () => {
      return `You’ve successfully ${validate_component(Highlight, "Highlight").$$render($$result, {}, {}, {
        default: () => {
          return `evaluate, enrolled, trained, &amp; verified`;
        }
      })} your students
    ...
    default: () => {
      return `<div class="card-content svelte-wu4iii"><div class="content svelte-wu4iii"><div class="list svelte-wu4iii"><img src="/imgs/check-circle.png" alt="" class="svelte-wu4iii"> ${validate_component(Typography, "Typography").$$render($$result, { variant: "list" }, {}, {
        default: () => {
          return `Privately requested credentials for verification`;
        }
        ...
        default: () => {
          return `Securely verified and confirmed student internships`;
        }
      })}</div> <div class="p svelte-wu4iii">${validate_component(Typography, "Typography").$$render($$result, {}, {}, {
        default: () => {
          return `You have successfully navigated the privacy and simplicity of self-sovereign identity
							to prepare and verify students for international internships, and also verify their
							international credentials upon their return.
							<br><br>
							To learn more about SSI in education and
...
//# sourceMappingURL=_page.svelte-d9ace559.js.map
