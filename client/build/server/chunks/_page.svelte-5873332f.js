import { c as create_ssr_component, v as validate_component, e as escape, h as each, b as null_to_empty } from './index2-d11f8066.js';
          ...
          return `<div class="${"sidebar svelte-1c6jvmm"}">${each(Array(5), (i) => {
            ...
            {},
            {
              default: () => {
				...
				<div class="${"button-container svelte-1c6jvmm"}"><button class="${escape(null_to_empty(`button ${selected.length <= 0 && "disabled"}`), true) + " svelte-1c6jvmm"}">SEND INVITATIONS</button></div></div>`;
        }
      }
    )}</div></div>`;
  } while (!$$settled);
...
//# sourceMappingURL=_page.svelte-5873332f.js.map
