...
import { u as peterAssignedInternship } from './flows.store-Ch_DhNys.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container svelte-wu4iii"><div class="heading svelte-wu4iii">${validate_component(Typography, "Typography").$$render($$result, { variant: "heading" }, {}, {
    default: () => {
      return `<!-- HTML_TAG_START -->${highlight($_("journeys.peter.successfully_assigned_placements"))}<!-- HTML_TAG_END -->`;
    }
    ...
    default: () => {
      return `<div class="card-content svelte-wu4iii"><div class="content svelte-wu4iii"><div class="list svelte-wu4iii"><img src="/imgs/check-circle.png" alt="" class="svelte-wu4iii"> ${validate_component(Typography, "Typography").$$render($$result, { variant: "list" }, {}, {
        default: () => {
          return `${escape($_("journeys.peter.evaluated_student_course_results"))}`;
        }
        ...
        default: () => {
          return `${escape($_("journeys.peter.issued_course_badges"))}`;
        }
      })}</div> <div class="list svelte-wu4iii"><img src="/imgs/check-circle.png" alt="" class="svelte-wu4iii"> ${validate_component(Typography, "Typography").$$render($$result, { variant: "list" }, {}, {
        default: () => {
          return `${escape($_("journeys.peter.issued_internship_placements"))}`;
        }
      })}</div> <div class="p svelte-wu4iii">${validate_component(Typography, "Typography").$$render($$result, {}, {}, {
        default: () => {
          return `${escape($_("journeys.peter.completed_peter_journey"))} <br><br> ${escape($_("journeys.peter.verify_internship_completion"))} <br><br> ${escape($_("journeys.peter.click_to_proceed"))}`;
        }
        ...
        {},
        {}
      )}</div> <div class="img svelte-wu4iii" data-svelte-h="svelte-1cx75dx"><img src="/imgs/peter-2.svg" alt="" class="svelte-wu4iii"></div></div>`;
    }
  })}</div></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-BQcvtYCm.js.map
