...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container svelte-wu4iii"><div class="heading svelte-wu4iii">${validate_component(Typography, "Typography").$$render($$result, { variant: "heading" }, {}, {
    default: () => {
      return `<!-- HTML_TAG_START -->${highlight($_("journeys.peter.successfully_evaluated_enrolled_trained_verified"))}<!-- HTML_TAG_END -->`;
    }
    ...
    default: () => {
      return `<div class="card-content svelte-wu4iii"><div class="content svelte-wu4iii"><div class="list svelte-wu4iii"><img src="/imgs/check-circle.png" alt="" class="svelte-wu4iii"> ${validate_component(Typography, "Typography").$$render($$result, { variant: "list" }, {}, {
        default: () => {
          return `${escape($_("journeys.peter.pvtly_requested_creds_for_verification"))}`;
        }
        ...
        default: () => {
          return `${escape($_("journeys.peter.securely_verified_and_confirmed_student_internship"))}`;
        }
      })}</div> <div class="p svelte-wu4iii">${validate_component(Typography, "Typography").$$render($$result, {}, {}, {
        default: () => {
          return `${escape($_("journeys.peter.successfully_verified_student_internships"))} <br><br> ${escape($_("journeys.peter.learn_about_ssi_in_edu"))} <br><br> ${escape($_("journeys.peter.get_in_touch_with_ngdil_and_continue_journey"))}`;
        }
        ...
        {},
        {}
      )}</div> <div class="img svelte-wu4iii" data-svelte-h="svelte-1ekcmhe"><img src="/imgs/peter-3.svg" alt="" class="svelte-wu4iii"></div></div>`;
    }
  })}</div></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-CzVV71Tq.js.map
