...
import { e as dominiqueSharedCred } from './flows.store-72d7210a.js';
    ...
    default: () => {
      return `<div class="${"card-content svelte-wu4iii"}"><div class="${"content svelte-wu4iii"}"><div class="${"list svelte-wu4iii"}"><img src="${"/imgs/check-circle.png"}" alt="${""}" class="${"svelte-wu4iii"}">
        ...
        {}
				...
				<div class="${"img svelte-wu4iii"}"><img src="${"/imgs/dominique-2.svg"}" alt="${""}" class="${"svelte-wu4iii"}"></div></div>`;
    }
  })}</div></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-ae822406.js.map
