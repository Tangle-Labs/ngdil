import { c as create_ssr_component } from './index-78a5ef04.js';
...
const Highlight = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<span class="${"highlight svelte-hclyi0"}">${slots.default ? slots.default({}) : ``}
	${``}</span>`;
});

export { Highlight as H };
//# sourceMappingURL=Highlight-608665b0.js.map
