import { c as create_ssr_component, a as subscribe, v as validate_component, f as each, d as add_attribute, e as escape, b as null_to_empty } from './index-78a5ef04.js';
...
import { f as dominiqueSelectedCourse, g as dominqueCourses } from './flows.store-b2e554df.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"container svelte-joamgx"}"><div class="${"heading svelte-joamgx"}">${validate_component(Typography, "Typography").$$render($$result, { variant: "heading" }, {}, {
	...
	<div class="${"dash svelte-joamgx"}">${validate_component(BigBusinessCorp, "BigBusinessCorp").$$render($$result, {}, {}, {
    default: () => {
...
//# sourceMappingURL=_page.svelte-53ecf846.js.map
